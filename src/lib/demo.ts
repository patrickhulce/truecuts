...
components:
  - label: Bench
    ...
    parts:
      ...
      - { part: long-apron-1, position: [ 3.5, 26.5, 0.5 ], rotation: [ 0, 0, 0 ] }
      - { part: long-apron-2, position: [ 3.5, 26.5, 22 ], rotation: [ 0, 0, 0 ] }
      - { part: short-apron-1, position: [ 0.5, 26.5, 22.5 ], rotation: [ 0, 90, 0 ] }
      - { part: short-apron-2, position: [ 38, 26.5, 22.5 ], rotation: [ 0, 90, 0 ] }
      ...
      - { part: corner-bracket-2, position: [ 36.5, 26.5, 0 ], rotation: [ 90, -90, 0 ] }
      - { part: corner-bracket-3, position: [ 3.5, 26.5, 22.5 ], rotation: [ 90, 0, 0 ] }
      - { part: corner-bracket-4, position: [ 36.5, 26.5, 22.5 ], rotation: [ -90, -90, 180 ] }
    fasteners:
      ...
      - stock: screw-wood-8x2.5
        members:
          ...
          - { part: leg-1, at: [ 28.25, 0, 1.25 ], direction: [ 0, -1, 0 ] }
      - stock: screw-wood-8x2.5
        members:
          - { part: long-apron-1, at: [ 33, 1.75, 0.75 ], direction: [ 1, 0, 0 ] }
          - { part: leg-2, at: [ 28.25, 3.5, 1.25 ], direction: [ 0, 1, 0 ] }
      - stock: screw-wood-8x2.5
        members:
          - { part: long-apron-2, at: [ 0, 1.75, 0.75 ], direction: [ -1, 0, 0 ] }
          - { part: leg-3, at: [ 28.25, 0, 0.25 ], direction: [ 0, -1, 0 ] }
      - stock: screw-wood-8x2.5
        members:
          - { part: long-apron-2, at: [ 33, 1.75, 0.75 ], direction: [ 1, 0, 0 ] }
          - { part: leg-4, at: [ 28.25, 3.5, 0.25 ], direction: [ 0, 1, 0 ] }
      - stock: screw-wood-8x2.5
        members:
          - { part: short-apron-1, at: [ 21, 1.75, 0.75 ], direction: [ 1, 0, 0 ] }
          - { part: leg-1, at: [ 28.25, 2.25, 1.5 ], direction: [ 0, 0, 1 ] }
      - stock: screw-wood-8x2.5
        members:
          - { part: short-apron-1, at: [ 0, 1.75, 0.75 ], direction: [ -1, 0, 0 ] }
          - { part: leg-3, at: [ 28.25, 2.25, 0 ], direction: [ 0, 0, -1 ] }
      - stock: screw-wood-8x2.5
        members:
          - { part: short-apron-2, at: [ 21, 1.75, 0.75 ], direction: [ 1, 0, 0 ] }
          - { part: leg-2, at: [ 28.25, 1.25, 1.5 ], direction: [ 0, 0, 1 ] }
      - stock: screw-wood-8x2.5
        members:
          - { part: short-apron-2, at: [ 0, 1.75, 0.75 ], direction: [ -1, 0, 0 ] }
          - { part: leg-4, at: [ 28.25, 1.25, 0 ], direction: [ 0, 0, -1 ] }
      ...
      - stock: screw-wood-8x1.25
        members:
          ...
          - { part: long-apron-1, at: [ 0.75, 0, 0.25 ], direction: [ 0, -1, 0 ] }
      - stock: screw-wood-8x1.25
        members:
      ...
      - stock: screw-wood-8x1.25
        members:
          ...
          - { part: long-apron-1, at: [ 32.25, 0, 0.25 ], direction: [ 0, -1, 0 ] }
      - stock: screw-wood-8x1.25
        members:
      ...
      - stock: screw-wood-8x1.25
        members:
          ...
          - { part: long-apron-2, at: [ 0.75, 0, 1.25 ], direction: [ 0, -1, 0 ] }
      - stock: screw-wood-8x1.25
        members:
      ...
      - stock: screw-wood-8x1.25
        members:
          ...
          - { part: long-apron-2, at: [ 32.25, 0, 1.25 ], direction: [ 0, -1, 0 ] }
      - stock: screw-wood-8x1.25
        members:
      ...
      - stock: screw-wood-8x1.25
        members:
          - { part: top-1, at: [ 20, 1.25, 0.75 ], direction: [ 0, 0, 1 ] }
          - { part: long-apron-1, at: [ 16.5, 3.5, 0.75 ], direction: [ 0, 1, 0 ] }
      - stock: screw-wood-8x1.25
        members:
          - { part: top-1, at: [ 20, 22.75, 0.75 ], direction: [ 0, 0, 1 ] }
          - { part: long-apron-2, at: [ 16.5, 3.5, 0.75 ], direction: [ 0, 1, 0 ] }
      - stock: screw-wood-8x1.25
        members:
          - { part: top-1, at: [ 1.25, 12, 0.75 ], direction: [ 0, 0, 1 ] }
          - { part: short-apron-1, at: [ 10.5, 3.5, 0.75 ], direction: [ 0, 1, 0 ] }
      - stock: screw-wood-8x1.25
        members:
          - { part: top-1, at: [ 38.75, 12, 0.75 ], direction: [ 0, 0, 1 ] }
          - { part: short-apron-2, at: [ 10.5, 3.5, 0.75 ], direction: [ 0, 1, 0 ] }

  - label: Shelf
    position: [ 8, 26.5, 24 ]
    parts:
      - { part: shelf-board-1, position: [ 0, 0, -0.5 ], rotation: [ 0, 0, 0 ] }
